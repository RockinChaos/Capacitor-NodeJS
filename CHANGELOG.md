...
- fix: add max-page-size linker flag for native build

## [1.0.0-beta.10] - 2026-05-26

### Changed

- Update to Capacitor v8
  - **Breaking:** Drop support for Capacitor v7
- Bump nodejs-mobile core library to v18.20.4+16kb-fix ([#31](https://github.com/hampoelz/Capacitor-NodeJS/issues/31))
- **Breaking:** Remove electron support
